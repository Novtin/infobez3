...
<form:form modelAttribute="client" onsubmit="encryptHuman(event);" method="post" action="/user/registration" id="formSubmit">
    <table>
        <tr>
            <td>Логин:</td>
...
<footer>
    <a href="${pageContext.request.contextPath}/user/login" style="font-size: smaller">Войдите, если есть аккаунт</a>
</footer>
</body>
</html>